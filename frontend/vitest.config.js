...
export default defineConfig({
  ...
  test: {
    globals: true,
    setupFiles: ["./src/setup-msw.ts", "./src/setupTests.ts"],
    include: [
    ...
    // Run storybook/browser tests sequentially and temporarily disable coverage to
    // reduce memory/Chromium crashes in CI/dev containers.
    threads: false,
    maxThreads: 1,
    coverage: {
