declare namespace _default {
    ...
    export { EditLanguagePreferences as component };
    ...
    export namespace argTypes {
        ...
        namespace onLanguageFormChange {
            let action_2: string;
...
export const EnglishSelected: any;
export const FrenchSelected: any;
export const NoSelection: any;
export const WithError: any;
export const FrenchInterface: any;
