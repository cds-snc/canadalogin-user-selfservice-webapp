...
import {buildTestCase, Template, TestTemplate} from "../../Tests/utils/functions.tsx";
...
export const ConfirmNameChangeEnglish = TestTemplate.bind({});
ConfirmNameChangeEnglish.args = {
    firstName: "John",
    lastName: "Doe"
};
...
export const ConfirmNameChangeFrench = TestTemplate.bind({});
ConfirmNameChangeFrench.args = {
    firstName: "Jean",
    lastName: "Dupont"
};
