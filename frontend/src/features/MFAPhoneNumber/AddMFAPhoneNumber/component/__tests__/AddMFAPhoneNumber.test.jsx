  ...
  getPageContent: vi.fn((language, page) => {
    ...
    if (language === "fr") {
      return {
        ...
        9: "Certains pays ne sont pas pris en charge en raison de limitations techniques. Si votre pays n'apparaît pas dans la liste, vous ne pouvez pas créer de compte ConnexionCanada à l'heure actuelle. Nous nous excusons des désagréments que cela pourrait causer.",
