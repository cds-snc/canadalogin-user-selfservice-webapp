...
export interface ServiceCanadaCentreFormData {
  idType: string;
  idExpiryDate: string;
  firstName: string;
  lastName: string;
...
export const getServiceCanadaCentreValidation = (
  formData: ServiceCanadaCentreFormData,
): ServiceCanadaCentreValidationResult => {
