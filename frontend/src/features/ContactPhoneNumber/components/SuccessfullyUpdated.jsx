...
export default function SuccessfullyUpdatedContactPhoneNumber({ onNext, onCancel, onChangePhoneForm, phoneFormData, userProfile }) {
    const { language } = useParams();
    const pageContentJson = getPageContent(language, PAGES.successfullyUpdatedContactPhoneNumber);
    ...
    return (
        <GcdsContainer>
            ...
            <GcdsGrid columns="1">
                ...
                <GcdsHeading marginBottom="150" tag="h1">{pageContentJson["2"]}</GcdsHeading>

                <GcdsHeading marginTop="0" marginBottom="0" tag="h3">{pageContentJson["3"]}</GcdsHeading>
