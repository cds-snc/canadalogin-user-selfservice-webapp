...
function PasskeyLogin() {
  ...
  const handlePasskeyAuth = async () => {
    try {
      ...
      const optionsResponse = await fetch(`${config.apiUrl}/api/auth/passkey/options`, {
        method: 'POST',
        headers: {
      ...
      console.log('Requesting credential with options:', publicKeyCredentialRequestOptions);
      ...
      const verificationResponse = await fetch(`${config.apiUrl}/api/auth/passkey/verify`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
