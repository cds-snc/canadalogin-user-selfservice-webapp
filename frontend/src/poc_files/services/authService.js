...
export const authService = {
    signup: async (userData) => {
        const response = await axios.post(`${config.apiUrl}/api/auth/signup`, userData);
        return response.data;
    },

    signupWithMFA: async (userData) => {
        const response = await axios.post(`${config.apiUrl}/api/auth/signup/mfa`, userData);
        return response.data;
    },

    verifyMFATOTP: async (verifyData) => {
        const response = await axios.post(`${config.apiUrl}/api/auth/signup/mfa`, verifyData);
        return response.data;
    },
