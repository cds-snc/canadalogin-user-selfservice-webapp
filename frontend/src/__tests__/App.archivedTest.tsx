...
describe("Routing Tests", () => {
  ...
  const langHref = {
    attribute: "lang-href",
    en: "/" + AVAILABLE_LANGUAGES.en,
    fr: "/" + AVAILABLE_LANGUAGES.fr,
  };
  ...
  test("Manage profile landing page with en language defined", () => {
    ...
    buildTestSuite.test(
      AVAILABLE_LANGUAGES.en,
      PAGES.manageDashboard,
      FLOW_TYPES.manage,
      null,
      langHref.fr + NAVIGATION_LINKS.manage,
    );
  });
  ...
  test("Manage profile landing page with fr language defined", () => {
    ...
    buildTestSuite.test(
      ...
      FLOW_TYPES.manage,
      null,
      langHref.en + NAVIGATION_LINKS.manage,
    );
  });
