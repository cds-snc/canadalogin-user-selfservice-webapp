...
CONTACT_INFO = {
    ...
    "url": config_settings.app_info.github_url,
    "email": config_settings.app_info.email
}
...
async def lifespan(app: FastAPI):
    # Load the ML model
    app.state.config = get_settings()  # ✅ Store in app.state
...
app = FastAPI(
    lifespan=lifespan,
    title=config_settings.app_info.app_name,
