...
│       │   └── ecs/           # Elastic Container Service
│       └── shared/
│           └── vpc/           # Shared VPC used by both frontend and backend
...
- All resources are tagged with `project` and `environment` tags
...
- Both frontend and backend services share the same VPC for optimal network performance and security
